 ...
 */
public class BetterTrapezoidProfile {
     ...
     */
    @Deprecated
    public BetterTrapezoidProfile(Constraints constraints, State goal, State initial) {
     ...
     */
    @Deprecated
    public BetterTrapezoidProfile(Constraints constraints, State goal) {
